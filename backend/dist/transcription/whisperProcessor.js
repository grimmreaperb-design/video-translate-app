...
exports.transcribeAudioFallback = transcribeAudioFallback;
...
async function transcribeAudio(wavFilePath) {
    ...
    try {
        ...
        return new Promise((resolve) => {
            const whisperProcess = (0, child_process_1.spawn)('whisper', [
                '--model', MODEL_PATH,
                '--file', wavFilePath,
                '--output-txt',
                '--no-timestamps',
...
async function transcribeAudioFallback(wavFilePath) {
...
async function transcribeWithFallback(wavFilePath) {
...
//# sourceMappingURL=whisperProcessor.js.map